...
const page = () => {
  return (
   ...
   <Link href='/home'> <IoArrowBackCircleOutline className='text-3xl hover:text-red-600 duration-300'/> </Link> <span className='font-light'>HP Victus 16</span>
    ...
    <img className="h-96 object-cover lg:object-scale-down lg:h-px-150" src="https://www.reliancedigital.in/medias/HP-Victus-16-d0309TX-493837856-i-1-1200Wx1200H?context=bWFzdGVyfGltYWdlc3wxODU4ODA5fGltYWdlL2pwZWd8aW1hZ2VzL2g0OC9oOWEvMTAwMTE4NDYzMTE5NjYuanBnfGRkM2M5YTU0ZWVlNWQ2OGIzMTUwMTdhY2Q0N2JlOTU3ZTY5ZmQwZDc1YmFkY2EyZDIwMmM1MDVhYzI0YjRjZDg"/>
    <span className='text-4xl flex '>HP VICTUS 16<SiWindows95 className='text-sm text-red-600' /></span><span className='text-xl'> ₹ 56,999 /-</span>
    </div>
